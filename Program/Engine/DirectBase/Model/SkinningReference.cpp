...
namespace SolEngine {
	...
	std::unique_ptr<SkinningReference> ResourceCreater<SkinningReference>::CreateObject(const ResourceSource<SkinningReference> &) const {
		...
		//	// データを末尾に構築
		//	auto &back = result->meshInfluence_.emplace_back();
		//	// メッシュを保存
		//	back.first = mesh;
		//	// 頂点データの領域を確保
